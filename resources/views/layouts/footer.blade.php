          ...
          <div class="row d-flex align-items-center">
            <div class="col-lg-4 d-flex justify-content-center justify-content-center justify-content-lg-start justify-content-xl-start">
              <div class="footer-link">
                <a href="{{route('terms-of-use')}}" class="text-white d-lg-block mb-3 px-3">ব্যবহারের শর্তাবল</a>
                <a href="{{route('contact')}}" class="text-white d-lg-block mb-3 px-3">যোগাযোগ</a>
              </div>
            </div>
...
<div class="container">
  <div class="row">
    <div class="col-xl-6 mt-3 text-white d-flex justify-content-center justify-content-lg-start justify-content-xl-start" style="font-size: 13px;">
      ©2021 <span> {{ Voyager::setting('site.copyright') }}</span>. All Rights Reserved.
    </div>
