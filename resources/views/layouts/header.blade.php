    ...
    <div class="container-fluid pt-4 pb-lg-3 px-lg-5">
      <div class="row">
        <div class="col-lg-4 col-md-12 col-sm-12 d-flex justify-content-lg-start justify-content-xl-start justify-content-center">
          <a href="{{route ('home')}}"><img class="img-fluid justify-content-xs-center justify-content-sm-center" src="{{ Voyager::image( Voyager::setting('site.logo')) }}" alt=""></a>
        </div>
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 d-flex justify-content-lg-end justify-content-xl-end justify-content-center justify-content-center">
          <div class="d-flex align-items-center social-media-icons">
            <a href="{{ Voyager::setting('site.facebook') }}" aria-label="Facebook" target="_blank" class="p-1" rel="nofollow noopener">
              <div class="social-icon facebook"><i class="fab fa-facebook-f"></i></div>
            </a>
            <a href="{{ Voyager::setting('site.youtube') }}" aria-label="Youtube" target="_blank" class="p-1" rel="nofollow noopener">
              <div class="social-icon youtube"><i class="fab fa-youtube"></i></div>
            </a>
            <a href="{{ Voyager::setting('site.twitter') }}" aria-label="Twitter" target="_blank" class="p-1" rel="nofollow noopener">
              <div class="social-icon twitter"><i class="fab fa-twitter"></i></div>
            </a>
            <a href="{{ Voyager::setting('site.instagram') }}" aria-label="Instagram" target="_blank" class="p-1" rel="nofollow noopener">
              <div class="social-icon instagram"><i class="fab fa-instagram"></i></div>
            </a>
            <a href="{{ Voyager::setting('site.linkedin') }}" aria-label="Linkedin" target="_blank" class="p-1" rel="nofollow noopener">
              <div class="social-icon linkedin"><i class="fab fa-linkedin-in"></i></div>
            </a>
            <a href="{{ Voyager::setting('site.podcast') }}" aria-label="Google Podcast" target="_blank" class="p-1" rel="nofollow noopener">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
            ...
            <li class="nav-item d-lg-block d-xl-block d-none">
              ...
              <div class="button-bars">
                <i style="font-size: 16px !important;" class="fas fa-bars"></i>
              </div>
...
<script src="{{ asset('js/share.js') }}"></script>
    ...
    $(function () {
    $(".box-news").slice(0, 15).show();
    $("#loadMore").on('click', function (e) {
    e.preventDefault();
    $(".box-news:hidden").slice(0, 15).slideDown();
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v12.0" nonce="VkfM8Vjm"></script>
  </body>
</html>